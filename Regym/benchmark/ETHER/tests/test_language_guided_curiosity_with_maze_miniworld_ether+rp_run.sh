...
--config=maze_miniworld_wandb_benchmark_ETHER+RP_config.yaml \
--time_limit=100 \
...
--RP_predictor_nbr_minibatches=4 --RP_predictor_batch_size=128 \
--RP_predictor_test_train_split_interval=5 --RP_test_replay_capacity=128 \
--RP_test_min_capacity=8 --RP_replay_period=1024 \
--RP_nbr_training_iteration_per_update=128 \
--RP_predictor_accuracy_threshold=0.99 \
