...
--config=keycorridor_S3_R3_minigrid_wandb_benchmark_POMDPERELELA_config.yaml \
...
--language_guided_curiosity_non_episodic_count_based_exploration='bonus-1.0' \
...
--ELA_rg_logits_mdl_principle_accuracy_threshold=0.0 \
