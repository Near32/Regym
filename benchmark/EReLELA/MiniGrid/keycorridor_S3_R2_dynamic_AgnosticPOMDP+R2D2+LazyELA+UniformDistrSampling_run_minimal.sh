...
--config=keycorridor_S3_R2_minigrid_wandb_benchmark_AgnosticPOMDPERELELA_config.yaml \
...
--ELA_rg_logits_mdl_principle_factor='10-0.1' \
--ELA_rg_logits_mdl_principle_normalization=True \
--ELA_rg_logits_mdl_principle_accuracy_threshold=-1.0 \
