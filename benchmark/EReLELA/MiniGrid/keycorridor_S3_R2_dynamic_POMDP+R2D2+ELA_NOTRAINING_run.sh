...
--ELA_rg_logits_mdl_principle_accuracy_threshold=0 \
--ELA_rg_logits_mdl_principle_factor=0 \
--ELA_rg_with_logits_mdl_principle=False \
--ELA_rg_max_sentence_length=128 \
--ELA_rg_nbr_epoch_per_update=1 \
--ELA_rg_nbr_test_distractors=0 \
--ELA_rg_nbr_train_distractors=0 \
