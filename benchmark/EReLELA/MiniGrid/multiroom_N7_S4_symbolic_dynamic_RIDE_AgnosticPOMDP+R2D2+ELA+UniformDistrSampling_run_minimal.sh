...
--use_cuda=True \
--project=EReLELA+R2D2-MultiRoom-Symbolic-Benchmark \
--success_threshold=0.01 \
--config=multiroom_N7_S4_symbolic_minigrid_wandb_RIDE_benchmark_AgnosticPOMDPERELELA+R2D2_config.yaml \
...
--ELA_rg_nbr_train_distractors=15 --ELA_rg_nbr_test_distractors=3 \
