...
--config=conditionalpickupobjectfast_miniworld_benchmark_AgnosticPOMDPERELELA_config.yaml \
...
--ELA_rg_compactness_ambiguity_metric_language_specs=emergent+natural+color+shape+blue+green+box+key+shuffled-emergent+shuffled-natural+shuffled-color+shuffled-shape \
