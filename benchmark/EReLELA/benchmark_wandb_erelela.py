...
def main():
    ...
    parser.add_argument("--training_iteration_stored_exp_period", type=int, default=32*270/10)
    ...
    parser.add_argument("--ELA_rg_relative_expressivity_threshold", type=float, default=0)
    parser.add_argument("--ELA_rg_expressivity_threshold", type=float, default=0)
    ...
    for task_config in tasks_configs:
        ...
        if args.use_ETHER and args.ETHER_rg_max_sentence_length != agent_config['THER_max_sentence_length']:
            ...
            import ipdb; ipdb.set_trace()
        if args.use_ETHER and args.ETHER_rg_vocab_size < agent_config['THER_vocab_size']:
