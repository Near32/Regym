...
--seed=10 --static_envs=False \
--use_cuda=True \
--project=EReLELA \
--success_threshold=0.999 \
--config=room17x10Objs_miniworld_wandb_benchmark_ETHER+R2D2+RP+ELA+SharedObsEncoder_config.yaml \
--language_guided_curiosity=True \
--language_guided_curiosity_extrinsic_weight=1.0 \
--language_guided_curiosity_intrinsic_weight=0.01 \
