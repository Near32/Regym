...
--ELA_rg_nbr_epoch_per_update=1 --ELA_rg_accuracy_threshold=90 \
--ELA_rg_nbr_train_distractors=31 --ELA_rg_nbr_test_distractors=7 \
--ELA_replay_capacity=2048 --ELA_test_replay_capacity=512 \
--ELA_rg_distractor_sampling=uniform \
--ELA_feedbacks_failure_reward=0 --ELA_feedbacks_success_reward=1 \
...
--adam_eps=1.0e-12 --optimization_epochs=8 \
