...
--config=babyAI_wandb_benchmark_SemanticEmbeddingsPriorContrastivelyRectifiedSharedFiLMedTHER_config.yaml \
--seed=30 \
--THER_contrastive_training_nbr_neg_examples=4 \
...
--THER_replay_period=1024 \
--THER_test_min_capacity=32 \
