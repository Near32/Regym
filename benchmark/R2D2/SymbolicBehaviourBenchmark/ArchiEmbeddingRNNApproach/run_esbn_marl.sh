...
--use_cuda=False --seed=10 --yaml_config=s2b_descr+feedback_comp_foc_1shot_r2d2_esbn_marl_benchmark_config.yaml \
...
--use_ORG=False \
--use_rule_based_agent=False --use_speaker_rule_based_agent=Falsee \
--speaker_rec_biasing=True --speaker_rec=True \
--node_id_to_extract=ObsKeyValueMemory:key_memory \
--listener_comm_rec_biasing=True --listener_comm_rec=True --listener_rec_biasing=True --listener_rec=True \
--listener_rec_period=20 --listener_comm_rec_period=20 \
