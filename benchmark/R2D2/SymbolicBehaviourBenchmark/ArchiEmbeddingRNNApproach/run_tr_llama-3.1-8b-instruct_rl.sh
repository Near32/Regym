...
HF_HOME=./hf_cache/ WANDB_CACHE_DIR=./wandb_cache/ python -m ipdb -c c benchmark_selfplay_s2b.py \
--success_threshold=0.5 \
--use_grammar=True \
--use_cuda=True --seed=10 --yaml_config=s2b_descr+feedback_comp_foc_1shot_N3m2M5_r2d2_tr_llama-3.1-8b-instruct_benchmark_config.yaml \
