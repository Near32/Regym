...
--use_cuda=True --seed=20 --yaml_config=s2b_descr+feedback_comp_foc_1shot_r2d2_comm2obs_dcem_benchmark_config.yaml \
...
--weights_entropy_reg_alpha=0.0 --r2d2_use_value_function_rescaling=False \
