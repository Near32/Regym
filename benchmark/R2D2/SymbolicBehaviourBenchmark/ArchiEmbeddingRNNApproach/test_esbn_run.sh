...
--use_cuda=True --seed=10 --yaml_config=s2b_descr+feedback_comp_foc_1shot_r2d2_esbn_benchmark_config.yaml \
--descriptive=True --max_nbr_values_per_latent=8 --min_nbr_values_per_latent=4 --sampling_strategy=component-focused-2shots \
