...
--config=room12x2Objs_miniworld_wandb_benchmark_ETHER+R2D2+RP+SharedObsEncoder_config.yaml \
...
--THER_use_THER=False --THER_use_THER_predictor_supervised_training=False \
