...
--min_capacity=5e3 --replay_capacity=1e3 --learning_rate=6.25e-5 \
...
--ETHER_rg_sanity_check_compactness_ambiguity_metric=True --MiniWorld_entity_visibility_oracle=True \
...
--ETHER_rg_nbr_epoch_per_update=3 --ETHER_rg_accuracy_threshold=99 \
