...
def make_rl_pubsubmanager(
    ...
    for aidx, (rlam_id, agent) in enumerate(zip(rlam_ids, agents)):
      ...
      rlam_input_stream_ids = {
        ...
        "reset_observations":f"modules:{envm_id}:ref:player_{aidx}:reset_observations",
        "reset_infos":f"modules:{envm_id}:ref:player_{aidx}:reset_infos",
...
def training_process(
    ...
    pixel_wrapping_fn = partial(
      ...
      remove_return_info_wrapper=task_config['remove_return_info_wrapper'],
      full_obs=task_config['full_obs'],
      single_pick_episode=task_config['single_pick_episode'],
      describe_achieved_pickup_goal=task_config['THER_describe_achieved_goal'],
      ...
      bespoke_env_oracle=task_config['bespoke_env_oracle'],
...
def main():
    ...
    parser.add_argument("--THER_log_samples", type=str2bool, default="False",)
    ...
    parser.add_argument("--THER_describe_achieved_goal", type=str2bool, default="False",)
    parser.add_argument("--bespoke_env_oracle", type=str2bool, default="False",)
    ...
    parser.add_argument("--THER_real_reward_scaler", type=float, default=1.0,)
    parser.add_argument("--THER_hindsight_reward_scaler", type=float, default=1.0,)
    ...
    parser.add_argument("--diversity_loss_weighting", type=str2bool, default="False",)
