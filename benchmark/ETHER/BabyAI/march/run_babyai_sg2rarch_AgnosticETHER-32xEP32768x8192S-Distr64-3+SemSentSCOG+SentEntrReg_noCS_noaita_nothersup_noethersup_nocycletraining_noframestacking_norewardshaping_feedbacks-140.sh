...
--use_cuda=True \
--config=babyAI_wandb_benchmark_MultiplicativeSemanticPrior_SmallGoal2RNNArchAgnosticETHER_noframestacking_config.yaml \
...
--ETHER_rg_max_sentence_length=128 \
...
--ETHER_rg_logits_mdl_principle_factor=1e-3 \
...
--ETHER_rg_semantic_cooccurrence_grounding_semantic_level=True \
--ETHER_rg_semantic_cooccurrence_grounding_semantic_level_ungrounding=True \
...
--ETHER_rg_semantic_cooccurrence_grounding_sentence_level_entropy_reg_lambda=1.0 \
...
--ETHER_rg_nbr_train_distractors=64 --ETHER_rg_nbr_test_distractors=3 \
--ETHER_replay_capacity=8192 --ETHER_test_replay_capacity=2048 \
--ETHER_rg_distractor_sampling='uniform' \
--ETHER_rg_use_cuda=True \
--ETHER_rg_dataloader_num_worker=4 \
--ETHER_rg_metric_fast=True --ETHER_rg_parallel_TS_worker=8 \
--ETHER_rg_metric_epoch_period=32 --ETHER_rg_dis_metric_epoch_period=32 \
--ETHER_rg_batch_size=128 \
--ETHER_rg_metric_batch_size=32 \
--ETHER_rg_nbr_train_points=1024 --ETHER_rg_nbr_eval_points=512 \
