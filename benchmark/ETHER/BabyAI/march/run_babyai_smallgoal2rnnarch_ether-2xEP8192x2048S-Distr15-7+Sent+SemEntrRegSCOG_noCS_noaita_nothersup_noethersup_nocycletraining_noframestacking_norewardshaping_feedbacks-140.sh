...
--ETHER_rg_semantic_cooccurrence_grounding_semantic_level_entropy_reg_lambda=1e-3 \
--ETHER_rg_semantic_cooccurrence_grounding_sentence_level_entropy_reg_lambda=1e-3 \
