...
--use_cuda=True \
--config=babyAI_wandb_benchmark_MultiplicativeSemanticPrior_OracleSmallGoal2RNNArchETHER_noframestacking_config.yaml \
...
--ETHER_rg_vocab_size=64 --ETHER_rg_training_period=100000 \
