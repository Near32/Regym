...
try:
    ...
    print(f"EnvironmentCreator: WARNING: {e}")

class EnvironmentCreator():
    def __init__(
        self, 
        environment_name_cli, 
        is_unity_environment, 
        is_gym_environment, 
        is_gymnasium_environment, 
        wrapping_fn=None, 
        env_config={},
    ):
        ...
        self.is_gymnasium_environment = is_gymnasium_environment
