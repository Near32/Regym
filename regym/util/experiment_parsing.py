...
from regym.rl_algorithms import build_R2D3DQfD_Agent
...
def initialize_agents(task, agent_configurations):
    ...
    def partial_match_build_function(agent_name, task, config):
        ...
        if 'r2d3_dqfd' in agent_name.lower() or 'r2d3dqfd' in agent_name.lower(): return build_R2D3DQfD_Agent(task, config, agent_name)
