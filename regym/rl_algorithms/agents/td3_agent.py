...
from ..algorithms.TD3 import TD3Algorithm, td3_critic_loss, td3_actor_loss
from ..networks import QNet, GaussianActorNet, EnsembleQNet
...
class TD3Agent(Agent):
    def __init__(self, name, algorithm):
        super(TD3Agent, self).__init__(name=name, algorithm=algorithm)
    ...
    def clone(self, training=None):
        ...
        clone = TD3Agent(name=self.name, algorithm=cloned_algo)
...
def build_TD3_Agent(task, config, agent_name):
    '''
   ...
   target_model_critic = EnsembleQNet(
    ...
    if 'use_HER' in kwargs and kwargs['use_HER']:
        ...
        td3_algorithm = HERAlgorithmWrapper(algorithm=td3_algorithm, 
                                            strategy=kwargs['HER_strategy'],
                                            goal_predicated_reward_fn=goal_predicated_reward_fn)

    agent = TD3Agent(name=agent_name, algorithm=td3_algorithm)
    ...
    print(td3_algorithm.get_models())
